<template>
  <div class="container-sm w-50 border border-primary shadow rounded mt-4 p-4 ">
    <ValidationObserver v-slot="{ handleSubmit}">
      <form @submit.prevent="handleSubmit(saveForm)">
        ...
        <div class="form-group">
          <ValidationProvider mode="passive" name="İmg Url" rules="required" v-slot="{ errors }">
            <input class="form-control" name="img url" placeholder="Book Img Url" type="url"
